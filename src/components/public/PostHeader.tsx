 ...
 */
export function PostHeader({ post, language }: { post: Pick<PostItem, "title" | "date" | "author" | "coverImage" | "tags">; language: string }) {
  return (
    <header className="nvx-post-head nvx-site-column pt-12 pb-4">
      <div className="max-w-3xl mx-auto">
        {post.coverImage ? (
          // eslint-disable-next-line @next/next/no-img-element
          <img src={post.coverImage} alt="" className="w-full aspect-[16/9] object-cover rounded-xl mb-8" />
        ) : null}
