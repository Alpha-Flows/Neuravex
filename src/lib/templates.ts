...
/**
 * A button that goes to another page of this same site.
 *
 * A template has no site to point at yet, so the address is written as a
 * stand-in and resolved when a site is created from it. Before this, every
 * button in every template pointed at `#`: the templates could not link to
 * their own pages even when they had any.
 */
function navBtn(label: string, pageSlug: string, color = "", variant = "primary", size = "lg", align = "center"): TemplateBlock {
  return b("button", { label, href: templateLink(pageSlug), variant, size, align, color, textColor: "" } as any);
}
/** A working contact form, stored in the CMS like any other submission. */
function form(submitLabel = "Send message", successMessage = "Thank you — we have your message and will be in touch shortly."): TemplateBlock {
  return b("form", {
    fields: [
...
/**
 * A row of columns whose cells hold more than one block each.
 *
 * Writing a heading row and the paragraph row under it as two separate `cols`
 * looks right at full width and comes apart the moment the row halves on a
 * narrower container: the two rows wrap independently, and a heading ends up
 * above somebody else's paragraph. Here each cell is one column and its
 * blocks are stamped with it, so a pair stays a pair wherever the row breaks.
 */
function cells(count: 2 | 3 | 4, gap: number, ...columns: TemplateBlock[][]) {
  return b("columns", { count, gap }, columns.flatMap((col, i) => col.map((kid) => ({ ...kid, column: i }))));
}
...
export const TEMPLATES: Template[] = [
  ...
  // ===================================================================
  {
    ...
    pages: [{
      ...
      blocks: [
        ...
        sec("#0a0a0a", 120, "site", "left",
          ...
          b("columns", { count: 2, gap: 16 }, [
            ...
            b("button", { label: "Start a project →", href: templateLink("contact"), variant: "outline", size: "lg", align: "left", color: "#fafafa", textColor: "#fafafa" } as any),
          ]),
          s(80),
          img(IMG.heroAgency, ""),
        ),
        ...
        sec("#ffffff", 64, "4xl", "center",
          ...
          s(24),
          navBtn("Start a project", "contact", "", "primary", "lg", "center"),
        ),
      ],
    }, {
      title: "Services", slug: "services", published: true,
      blocks: [
        sec("#0a0a0a", 96, "site", "left",
          t("SERVICES", "sm", "#a3a3a3", "left"),
          s(12),
          h("Three things, done properly.", 1, "#fafafa", "bold", "left"),
          s(16),
          t("We are deliberately narrow. If your problem is one of these, nobody will do it better; if it is not, we will tell you and point you somewhere good.", "xl", "#737373", "left"),
        ),
        sec("#ffffff", 96, "site", "left",
          cells(3, 40,
            [
              b("heading", { text: "Product design", level: 3, align: "left", color: "#171717", weight: "semibold" } as any),
              t("Research, flows and interface for a product you already know people want. Eight to twelve weeks, one designer embedded in your team.", "base", "#525252", "left"),
            ],
            [
              b("heading", { text: "Design systems", level: 3, align: "left", color: "#171717", weight: "semibold" } as any),
              t("A component library your engineers will actually use, documented and shipped into your codebase rather than handed over as a file.", "base", "#525252", "left"),
            ],
            [
              b("heading", { text: "Front-end build", level: 3, align: "left", color: "#171717", weight: "semibold" } as any),
              t("React and TypeScript, built to the design rather than approximating it. We stay until it is in production.", "base", "#525252", "left"),
            ],
          ),
        ),
        sec("#fafafa", 96, "5xl", "left",
          h("How an engagement runs", 2, "#171717", "bold", "left"),
          s(24),
          lst([
            "Week 0 — a paid two-day discovery. You keep the output whether or not we continue.",
            "Weeks 1–2 — research and a first direction, reviewed together.",
            "Weeks 3–10 — design and build in weekly increments you can use.",
            "Handover — code, files and a walkthrough recorded for whoever joins later.",
          ], "number"),
        ),
        sec("#0a0a0a", 80, "4xl", "center",
          h("Tell us what you are building", 2, "#fafafa", "bold"),
          s(12),
          t("We take on three or four new projects a quarter. The earlier you talk to us, the more we can help.", "lg", "#737373", "center"),
          s(24),
          navBtn("Start a project", "contact", "#fafafa", "secondary", "lg", "center"),
        ),
      ],
    }, {
      ...
      blocks: [
        sec("#0a0a0a", 96, "site", "left",
          t("CONTACT", "sm", "#a3a3a3", "left"),
          s(12),
          h("Let's talk about the work.", 1, "#fafafa", "bold", "left"),
          s(16),
          t("Tell us roughly what you are making, when it needs to exist, and what is in the way. We reply to everything within one working day.", "xl", "#737373", "left"),
        ),
        sec("#ffffff", 80, "4xl", "center",
          form("Send it over", "Thanks — we have it, and you will hear from a person within a working day."),
        ),
        sec("#fafafa", 64, "5xl", "left",
          cells(3, 32,
            [
              b("heading", { text: "Email", level: 4, align: "left", color: "#171717", weight: "semibold" } as any),
              t("hello@the.studio", "base", "#525252", "left"),
            ],
            [
              b("heading", { text: "Studio", level: 4, align: "left", color: "#171717", weight: "semibold" } as any),
              t("14 Rivington Street, London EC2A 3DU", "base", "#525252", "left"),
            ],
            [
              b("heading", { text: "New business", level: 4, align: "left", color: "#171717", weight: "semibold" } as any),
              t("We answer these ourselves. No account managers.", "base", "#525252", "left"),
            ],
          ),
        ),
      ],
    ...
    pages: [{
      ...
      blocks: [
        ...
        sec("#064e3b", 80, "5xl", "center",
          ...
          s(32),
          b("columns", { count: 2, gap: 16 }, [
            navBtn("Reserve a table", "visit", "", "primary", "lg", "center"),
            b("button", { label: "View the menu →", href: templateLink("menu"), variant: "outline", size: "lg", align: "center", color: "", textColor: "#facc15" } as any),
          ]),
          s(8),
      ...
      title: "Menu", slug: "menu", published: true,
      blocks: [
        sec("#064e3b", 80, "5xl", "center",
          t("THIS WEEK", "sm", "#6ee7b7", "center"),
          s(8),
          h("The menu", 1, "#f0fdf4", "bold"),
          s(12),
          t("Written on Tuesday, cooked until Sunday, changed whenever the farms change. Everything is served at the table; nothing is plated in advance.", "lg", "#a7f3d0", "center"),
        ),
        sec("#ffffff", 80, "5xl", "left",
          h("Spring tasting  ·  $95", 2, "#064e3b", "bold", "left"),
          s(8),
          t("Six courses. Wine pairing +$55. The whole table dines together.", "base", "#525252", "left"),
          s(24),
          cols(2, 32,
            lst([
              "Wild ramp velouté, cultured butter",
        ...
        sec("#f8fafc", 80, "5xl", "left",
          h("À la carte", 2, "#064e3b", "bold", "left"),
          s(8),
          t("Served at the bar every night we are open.", "base", "#525252", "left"),
          s(24),
          cols(2, 32,
            lst([
              "Oysters, mignonette  ·  4 each",
              "Bread, cultured butter  ·  9",
              "Chicory, walnut, aged gouda  ·  16",
              "Hand-cut tagliatelle, spring garlic  ·  24",
            ], "bullet"),
            lst([
              "Whole roast fish for two  ·  58",
              "Dry-aged sirloin, bone marrow  ·  46",
              "Cheese, three American artisans  ·  18",
              "Olive oil cake, crème fraîche  ·  12",
            ], "bullet"),
          ),
        ),
        s(48),
        img(IMG.food2, ""),
        sec("#064e3b", 80, "4xl", "center",
          h("Come and eat", 2, "#f0fdf4", "bold"),
          s(12),
          t("Reservations open two weeks ahead. The bar is always walk-in.", "lg", "#a7f3d0", "center"),
          s(24),
          navBtn("Plan your visit", "visit", "", "primary", "lg", "center"),
        ),
      ],
    }, {
      title: "Visit", slug: "visit", published: true,
      blocks: [
        sec("#064e3b", 80, "5xl", "center",
          h("Visit us", 1, "#f0fdf4", "bold"),
          s(12),
          t("242 Court Street, Cobble Hill, Brooklyn. Five minutes from the Bergen Street F and G.", "xl", "#a7f3d0", "center"),
        ),
        sec("#ffffff", 80, "5xl", "left",
          cells(3, 32,
            [
              b("heading", { text: "Hours", level: 4, align: "left", color: "#064e3b", weight: "semibold" } as any),
              t("Dinner Wednesday to Sunday, 5:30 PM – 10:00 PM. Closed Monday and Tuesday.", "base", "#525252", "left"),
            ],
            [
              b("heading", { text: "Finding us", level: 4, align: "left", color: "#064e3b", weight: "semibold" } as any),
              t("242 Court Street, Brooklyn, NY 11201. Street parking after 7 PM; the garage on Kane Street is a short walk.", "base", "#525252", "left"),
            ],
            [
              b("heading", { text: "Good to know", level: 4, align: "left", color: "#064e3b", weight: "semibold" } as any),
              t("The dining room seats 32. We can cook around most allergies with a day's notice — tell us when you book.", "base", "#525252", "left"),
            ],
          ),
        ),
        s(32),
        img(IMG.interior, "The dining room — 32 seats, an open kitchen, and a 200-bottle wine wall"),
        sec("#f8fafc", 80, "4xl", "center",
          h("Book a table", 2, "#064e3b", "bold"),
          s(12),
          t("Tell us the date, the time and how many of you there are. We confirm by email the same day.", "lg", "#525252", "center"),
          s(24),
          form("Request a table", "Thank you — we have your request and will confirm by email today."),
          s(16),
          t("Or call us on (718) 555-0182 between 3 PM and 10 PM.", "sm", "#059669", "center"),
        ),
      ],
    }],
  },
    ...
    pages: [{
      ...
      blocks: [
        sec("#ffffff", 96, "site", "left",
          cols(2, 48,
            sec("transparent", 0, "full", "left",
              ...
              s(24),
              b("columns", { count: 2, gap: 16 }, [
                navBtn("About us", "about", "#0f172a", "primary", "md", "left"),
                b("button", { label: "Get in touch →", href: templateLink("contact"), variant: "outline", size: "md", align: "left", color: "#0f172a", textColor: "#0f172a" } as any),
              ]),
            ),
            img(IMG.workspace, ""),
          ),
        ...
        sec("#0f172a", 80, "4xl", "center",
          ...
          s(24),
          navBtn("Schedule a call", "contact", "", "primary", "lg", "center"),
        ),
      ],
    }, {
      title: "About", slug: "about", published: true,
      blocks: [
        sec("#ffffff", 96, "site", "center",
          t("ABOUT US", "sm", "#94a3b8", "center"),
          s(8),
          h("Built to outlast a funding cycle", 1, "#0f172a", "bold"),
          s(16),
          t("Founded in 2009, employee-owned since 2016, profitable every year since 2018. We are not going anywhere, which is the whole point of hiring us.", "xl", "#475569", "center"),
        ),
        sec("#f8fafc", 96, "5xl", "left",
          h("How we got here", 2, "#0f172a", "bold", "left"),
          s(16),
          t("We started with four people and one customer who needed their operations moved off a spreadsheet. That customer is still with us.", "lg", "#475569", "left"),
          s(16),
          t("Fifteen years on there are 240 of us across three offices, and the work is recognisably the same: take something a business depends on, make it reliable, and leave the team better able to run it than when we arrived.", "lg", "#475569", "left"),
        ),
        sec("#ffffff", 96, "site", "center",
          h("What we hold to", 2, "#0f172a", "bold"),
          s(40),
          cells(3, 32,
            [
              b("heading", { text: "Say the hard thing", level: 4, align: "center", color: "#0f172a", weight: "semibold" } as any),
              t("If a project is going badly you will hear it from us first, with a plan attached.", "base", "#475569", "center"),
            ],
            [
              b("heading", { text: "Finish what we start", level: 4, align: "center", color: "#0f172a", weight: "semibold" } as any),
              t("We do not hand over at 80% and call it a phase. Done means running in production.", "base", "#475569", "center"),
            ],
            [
              b("heading", { text: "Leave it maintainable", level: 4, align: "center", color: "#0f172a", weight: "semibold" } as any),
              t("Your team, not ours, should be able to change it next year. We write the documentation that makes that true.", "base", "#475569", "center"),
            ],
          ),
        ),
        s(48),
        img(IMG.team, "Our operations team at the Chicago office"),
        sec("#f8fafc", 80, "4xl", "center",
          h("Work with us", 2, "#0f172a", "bold"),
          s(12),
          t("Tell us what is not working. The first conversation costs nothing and usually helps anyway.", "lg", "#475569", "center"),
          s(24),
          navBtn("Get in touch", "contact", "", "primary", "lg", "center"),
        ),
      ],
    }, {
      title: "Contact", slug: "contact", published: true,
      blocks: [
        sec("#ffffff", 96, "site", "center",
          h("Contact", 1, "#0f172a", "bold"),
          s(16),
          t("One form, read by a person, answered within one working day.", "xl", "#475569", "center"),
        ),
        sec("#f8fafc", 80, "4xl", "center",
          form("Send message", "Thank you — your message is with us and you will hear back within one working day."),
        ),
        sec("#ffffff", 80, "5xl", "center",
          cells(3, 32,
            [
              b("heading", { text: "General", level: 4, align: "center", color: "#0f172a", weight: "semibold" } as any),
              t("hello@example.com  ·  +1 (312) 555-0140", "base", "#475569", "center"),
            ],
            [
              b("heading", { text: "New business", level: 4, align: "center", color: "#0f172a", weight: "semibold" } as any),
              t("newbusiness@example.com", "base", "#475569", "center"),
            ],
            [
              b("heading", { text: "Press", level: 4, align: "center", color: "#0f172a", weight: "semibold" } as any),
              t("press@example.com", "base", "#475569", "center"),
            ],
          ),
        ),
      ],
    ...
    pages: [{
      ...
      blocks: [
        sec("#ffffff", 80, "site", "left",
          cols(2, 48,
            sec("transparent", 0, "full", "left",
              ...
              s(24),
              navBtn("Browse listings", "listings", "", "primary", "lg", "left"),
            ),
            img(IMG.property, ""),
          ),
        ),
        sec("#ffffff", 64, "site", "center",
          ...
          s(32),
          navBtn("View all 24 listings", "listings", "", "outline", "md", "center"),
        ),
        sec("#f8fafc", 80, "5xl", "left",
          ...
          s(32),
          navBtn("Contact Amanda", "contact", "", "primary", "md", "left"),
        ),
      ],
    }, {
      title: "Listings", slug: "listings", published: true,
      blocks: [
        sec("#ffffff", 80, "site", "left",
          t("CURRENT LISTINGS", "sm", "#94a3b8", "left"),
          s(8),
          h("On the market now", 1, "#171717", "bold", "left"),
          s(16),
          t("Nine properties, all viewed by us in person. Prices are what the seller will take, not what the portal says.", "xl", "#475569", "left"),
        ),
        sec("#f8fafc", 80, "site", "left",
          cells(2, 40,
            [
              b("heading", { text: "14 Arbour Hill  ·  $1,240,000", level: 3, align: "left", color: "#171717", weight: "semibold" } as any),
              t("Four bedrooms, south-facing garden, rebuilt roof in 2022. Chain-free and ready to move into.", "base", "#475569", "left"),
            ],
            [
              b("heading", { text: "3 Mill Lane  ·  $865,000", level: 3, align: "left", color: "#171717", weight: "semibold" } as any),
              t("A converted mill with the original beams kept. Two bedrooms, a studio, and river frontage.", "base", "#475569", "left"),
            ],
          ),
          s(32),
          cells(2, 40,
            [
              b("heading", { text: "8 Chapel Row  ·  $520,000", level: 3, align: "left", color: "#171717", weight: "semibold" } as any),
              t("A first flat that is not a compromise: two bedrooms, a real kitchen, and a station eight minutes' walk away.", "base", "#475569", "left"),
            ],
            [
              b("heading", { text: "The Old Dairy  ·  $1,980,000", level: 3, align: "left", color: "#171717", weight: "semibold" } as any),
              t("Six bedrooms on two acres. Needs a kitchen and some patience; everything structural is already done.", "base", "#475569", "left"),
            ],
          ),
        ),
        s(40),
        img(IMG.property, ""),
        sec("#ffffff", 80, "4xl", "center",
          h("Want to see one?", 2, "#171717", "bold"),
          s(12),
          t("We show properties seven days a week, including evenings.", "lg", "#475569", "center"),
          s(24),
          navBtn("Book a viewing", "contact", "", "primary", "lg", "center"),
        ),
      ],
    }, {
      title: "Contact", slug: "contact", published: true,
      blocks: [
        sec("#ffffff", 80, "site", "left",
          h("Book a viewing", 1, "#171717", "bold", "left"),
          s(16),
          t("Tell us which property and when suits you. We will confirm the same day, and we will tell you honestly if it is wrong for you.", "xl", "#475569", "left"),
        ),
        sec("#f8fafc", 80, "4xl", "center",
          form("Book a viewing", "Thank you — we will confirm your viewing by email today."),
        ),
        sec("#ffffff", 64, "5xl", "left",
          cells(3, 32,
            [
              b("heading", { text: "Office", level: 4, align: "left", color: "#171717", weight: "semibold" } as any),
              t("22 Market Square  ·  (555) 010-0188  ·  Mon–Sat 9 AM – 6 PM", "base", "#475569", "left"),
            ],
            [
              b("heading", { text: "Viewings", level: 4, align: "left", color: "#171717", weight: "semibold" } as any),
              t("Seven days a week, including evenings until 8 PM.", "base", "#475569", "left"),
            ],
            [
              b("heading", { text: "Selling instead?", level: 4, align: "left", color: "#171717", weight: "semibold" } as any),
              t("We value in person, never by algorithm, and there is no fee until it sells.", "base", "#475569", "left"),
            ],
          ),
        ),
      ],
    ...
    pages: [{
      ...
      blocks: [
        sec("#fffbeb", 96, "5xl", "left",
          ...
          s(24),
          navBtn("See our services", "services", "", "primary", "lg", "left"),
        ),
        sec("#ffffff", 96, "site", "center",
        ...
        sec("#f8fafc", 80, "site", "center",
          ...
          s(40),
          navBtn("Book a free assessment", "contact", "", "primary", "lg", "center"),
        ),
      ],
    }, {
      title: "Services", slug: "services", published: true,
      blocks: [
        sec("#fffbeb", 96, "site", "center",
          t("SERVICES", "sm", "#b45309", "center"),
          s(8),
          h("Three ways we are useful", 1, "#171717", "bold"),
          s(16),
          t("Each is fixed-scope and fixed-price. You will know what it costs and when it ends before it starts.", "xl", "#525252", "center"),
        ),
        sec("#ffffff", 96, "site", "left",
          cells(3, 40,
            [
              b("heading", { text: "Diagnostic  ·  2 weeks", level: 3, align: "left", color: "#171717", weight: "semibold" } as any),
              t("Interviews, data and a written answer to one question you cannot settle internally. You keep the analysis either way.", "base", "#525252", "left"),
            ],
            [
              b("heading", { text: "Programme  ·  3–6 months", level: 3, align: "left", color: "#171717", weight: "semibold" } as any),
              t("We run the change with your team rather than beside it, and we leave when your people can run it without us.", "base", "#525252", "left"),
            ],
            [
              b("heading", { text: "Advisory  ·  ongoing", level: 3, align: "left", color: "#171717", weight: "semibold" } as any),
              t("A day a month with the people making the decisions. Most useful once something is already working.", "base", "#525252", "left"),
            ],
          ),
        ),
        sec("#fffbeb", 96, "5xl", "left",
          h("What you get, every time", 2, "#171717", "bold", "left"),
          s(24),
          lst([
            "A named partner who is in the room, not on the proposal",
            "A written recommendation you could act on without us",
            "Weekly progress in plain language, including what went badly",
            "A fixed price agreed before we start",
          ], "check"),
        ),
        sec("#ffffff", 80, "4xl", "center",
          h("Start with the diagnostic", 2, "#171717", "bold"),
          s(12),
          t("Two weeks, one question, and no obligation to do anything with the answer.", "lg", "#525252", "center"),
          s(24),
          navBtn("Get in touch", "contact", "", "primary", "lg", "center"),
        ),
      ],
      ...
      blocks: [
        sec("#fffbeb", 96, "site", "center",
          h("Get in touch", 1, "#171717", "bold"),
          s(16),
          t("Tell us the question you are stuck on. If we are not the right people we will say so and suggest who is.", "xl", "#525252", "center"),
        ),
        sec("#ffffff", 80, "4xl", "center",
          form("Send", "Thank you — a partner will read this and reply within one working day."),
        ),
        sec("#fffbeb", 64, "5xl", "center",
          cells(3, 32,
            [
              b("heading", { text: "Email", level: 4, align: "center", color: "#171717", weight: "semibold" } as any),
              t("partners@example.com", "base", "#525252", "center"),
            ],
            [
              b("heading", { text: "Offices", level: 4, align: "center", color: "#171717", weight: "semibold" } as any),
              t("London and Amsterdam", "base", "#525252", "center"),
            ],
            [
              b("heading", { text: "Availability", level: 4, align: "center", color: "#171717", weight: "semibold" } as any),
              t("We take on two new engagements a quarter.", "base", "#525252", "center"),
            ],
          ),
        ),
      ],
    ...
    pages: [{
      ...
      blocks: [
        sec("#f0fdf4", 96, "5xl", "center",
          ...
          s(32),
          b("columns", { count: 3, gap: 16 }, [
            navBtn("Donate now", "donate", "", "primary", "lg", "center"),
            b("button", { label: "Our work →", href: templateLink("our-work"), variant: "outline", size: "lg", align: "center", color: "", textColor: "#16a34a" } as any),
        ...
        sec("#f0fdf4", 80, "5xl", "center",
          ...
          cols(3, 32,
            ...
            s(8),
            navBtn("Give now", "donate", "", "primary", "md", "left"),
      ...
      title: "Our work", slug: "our-work", published: true,
      blocks: [
        sec("#f0fdf4", 80, "5xl", "center",
          t("OUR WORK", "sm", "#94a3b8", "center"),
          s(8),
          h("Where the money goes", 1, "#14532d", "bold"),
          s(16),
          t("Three programmes, one country, audited every year. Eighty-seven pence in every pound reaches them directly.", "xl", "#166534", "center"),
        ),
        sec("#ffffff", 80, "5xl", "left",
          cells(3, 32,
            [
              b("heading", { text: "Clean water", level: 3, align: "left", color: "#14532d", weight: "semibold" } as any),
              t("64 boreholes drilled and maintained, serving 41,000 people. Each one has a local committee funded for ten years of repairs.", "base", "#166534", "left"),
            ],
            [
              b("heading", { text: "School meals", level: 3, align: "left", color: "#14532d", weight: "semibold" } as any),
              t("A hot meal every school day for 9,200 children. Attendance in the schools we serve is up 31%.", "base", "#166534", "left"),
            ],
            [
              b("heading", { text: "Teacher training", level: 3, align: "left", color: "#14532d", weight: "semibold" } as any),
              t("310 teachers through a two-year programme, 94% of whom are still teaching three years later.", "base", "#166534", "left"),
            ],
          ),
        ),
        s(40),
        img(IMG.charity, ""),
        sec("#f0fdf4", 80, "4xl", "center",
          h("What a gift does", 2, "#14532d", "bold"),
          s(24),
          lst([
            "£15 — a month of school meals for one child",
            "£60 — a hand pump serviced for a year",
            "£250 — a teacher's first term of training",
            "£4,000 — a borehole, with ten years of maintenance",
          ], "check"),
          s(24),
          navBtn("Give now", "donate", "", "primary", "lg", "center"),
        ),
      ],
    }, {
      title: "Donate", slug: "donate", published: true,
      blocks: [
        sec("#f0fdf4", 80, "4xl", "center",
          h("Donate", 1, "#14532d", "bold"),
          s(16),
          t("Every gift is restricted to the programme you choose, and we write to you once a year to say what it did.", "xl", "#166534", "center"),
        ),
        sec("#ffffff", 80, "4xl", "center",
          h("Set up a gift", 2, "#14532d", "bold"),
          s(12),
          t("Tell us how you would like to give and we will send a single link — no account, no newsletter unless you ask.", "lg", "#166534", "center"),
          s(24),
          form("Send", "Thank you. We will email you a giving link within the hour."),
        ),
        sec("#f0fdf4", 64, "5xl", "left",
          cells(3, 32,
            [
              b("heading", { text: "Where it goes", level: 4, align: "left", color: "#14532d", weight: "semibold" } as any),
              t("87p in the pound to programmes, 9p to fundraising, 4p to running the charity.", "base", "#166534", "left"),
            ],
            [
              b("heading", { text: "Our accounts", level: 4, align: "left", color: "#14532d", weight: "semibold" } as any),
              t("Independently audited and published in full every October since 2011.", "base", "#166534", "left"),
            ],
            [
              b("heading", { text: "Leaving a legacy", level: 4, align: "left", color: "#14532d", weight: "semibold" } as any),
              t("A gift in your will is untaxed and, for us, the most useful kind there is. We are glad to talk it through.", "base", "#166534", "left"),
            ],
          ),
        ),
      ],
    ...
    pages: [{
      ...
      blocks: [
        sec("#0f172a", 80, "site", "left",
          ...
          s(24),
          navBtn("Schedule a consultation", "contact", "", "primary", "md", "left"),
          s(48),
          cols(4, 24,
        ...
        sec("#0f172a", 80, "4xl", "center",
          ...
          s(24),
          navBtn("Contact us", "contact", "", "primary", "lg", "center"),
        ),
      ],
    }, {
      title: "Practice areas", slug: "practice-areas", published: true,
      blocks: [
        sec("#0f172a", 80, "site", "left",
          t("PRACTICE AREAS", "sm", "#64748b", "left"),
          s(12),
          h("What we are instructed on", 1, "#f8fafc", "bold", "left"),
          s(16),
          t("Four areas, each led by a partner who has practised in it for more than a decade. We decline work outside them.", "xl", "#94a3b8", "left"),
        ),
        sec("#ffffff", 80, "5xl", "left",
          cells(2, 40,
            [
              b("heading", { text: "Commercial litigation", level: 3, align: "left", color: "#0f172a", weight: "semibold" } as any),
              t("Contract and shareholder disputes, injunctive relief, and arbitration. We have taken 40 matters to trial and settled a great many more on better terms because we were ready to.", "base", "#475569", "left"),
            ],
            [
              b("heading", { text: "Corporate & M&A", level: 3, align: "left", color: "#0f172a", weight: "semibold" } as any),
              t("Acquisitions, disposals and reorganisations from $2m to $400m. Partner-led from first call to completion, with no handover to a junior team.", "base", "#475569", "left"),
            ],
          ),
          s(40),
          cells(2, 40,
            [
              b("heading", { text: "Employment", level: 3, align: "left", color: "#0f172a", weight: "semibold" } as any),
              t("Executive exits, restrictive covenants, discrimination and whistleblowing claims — advising the company and, where there is no conflict, the individual.", "base", "#475569", "left"),
            ],
            [
              b("heading", { text: "Regulatory", level: 3, align: "left", color: "#0f172a", weight: "semibold" } as any),
              t("Investigations, enforcement and compliance in financial services and healthcare. We act early, which is usually what changes the outcome.", "base", "#475569", "left"),
            ],
          ),
        ),
        sec("#0f172a", 80, "4xl", "center",
          h("Speak to a partner", 2, "#f8fafc", "bold"),
          s(12),
          t("The first conversation is without charge and without obligation.", "lg", "#94a3b8", "center"),
          s(24),
          navBtn("Request a consultation", "contact", "", "primary", "lg", "center"),
        ),
      ],
    }, {
      title: "Contact", slug: "contact", published: true,
      blocks: [
        sec("#0f172a", 80, "site", "left",
          h("Request a consultation", 1, "#f8fafc", "bold", "left"),
          s(16),
          t("Describe the matter in outline. Do not send confidential documents until we have confirmed there is no conflict.", "xl", "#94a3b8", "left"),
        ),
        sec("#ffffff", 80, "4xl", "center",
          form("Request a consultation", "Thank you. A partner will review this and respond within one working day."),
        ),
        sec("#f8fafc", 64, "5xl", "left",
          cells(3, 32,
            [
              b("heading", { text: "Chambers", level: 4, align: "left", color: "#0f172a", weight: "semibold" } as any),
              t("One Founders Court, London EC2R 7HJ", "base", "#475569", "left"),
            ],
            [
              b("heading", { text: "Telephone", level: 4, align: "left", color: "#0f172a", weight: "semibold" } as any),
              t("+44 20 7555 0170, 8:30 AM – 6:30 PM", "base", "#475569", "left"),
            ],
            [
              b("heading", { text: "Out of hours", level: 4, align: "left", color: "#0f172a", weight: "semibold" } as any),
              t("Existing clients have a direct line to the partner acting for them.", "base", "#475569", "left"),
            ],
          ),
        ),
      ],
    ...
    pages: [{
      ...
      blocks: [
        sec("#ffffff", 64, "5xl", "left",
          ...
          s(24),
          navBtn("See our projects", "projects", "", "primary", "md", "left"),
        ),
        sec("#ffffff", 64, "site", "center",
      ...
      title: "Projects", slug: "projects", published: true,
      blocks: [
        sec("#ffffff", 64, "5xl", "left",
          t("SELECTED PROJECTS", "sm", "#94a3b8", "left"),
          s(8),
          h("Built work", 1, "#292524", "bold", "left"),
          s(16),
          t("Twelve buildings completed since 2014. All of them are still standing up well, which is the only review that counts.", "xl", "#78716c", "left"),
        ),
        sec("#fafafa", 64, "5xl", "left",
          cells(2, 40,
            [
              b("heading", { text: "Hillside House  ·  2023", level: 3, align: "left", color: "#292524", weight: "semibold" } as any),
              t("A family house cut into a north slope, so the garden sits on the roof. Passivhaus certified, built in nine months.", "base", "#78716c", "left"),
            ],
            [
              b("heading", { text: "The Foundry  ·  2021", level: 3, align: "left", color: "#292524", weight: "semibold" } as any),
              t("An iron works turned into 14 workspaces. We kept the crane rails and made them the lighting.", "base", "#78716c", "left"),
            ],
          ),
          s(32),
          cells(2, 40,
            [
              b("heading", { text: "Chapel Extension  ·  2019", level: 3, align: "left", color: "#292524", weight: "semibold" } as any),
              t("A Grade II chapel given a reading room in cross-laminated timber, touching the original in four places.", "base", "#78716c", "left"),
            ],
            [
              b("heading", { text: "Quay Library  ·  2017", level: 3, align: "left", color: "#292524", weight: "semibold" } as any),
              t("A small civic library on a tidal quay, raised a metre and detailed to be flooded without damage.", "base", "#78716c", "left"),
            ],
          ),
        ),
        s(40),
        img(IMG.building, ""),
        sec("#ffffff", 64, "4xl", "center",
          h("Thinking about a project?", 2, "#292524", "bold"),
          s(12),
          t("We take on four or five a year and like to be involved before the site is bought.", "lg", "#78716c", "center"),
          s(24),
          navBtn("About the studio", "studio", "", "primary", "lg", "center"),
        ),
      ],
    }, {
      title: "Studio", slug: "studio", published: true,
      blocks: [
        sec("#ffffff", 64, "5xl", "left",
          h("The studio", 1, "#292524", "bold", "left"),
          s(16),
          t("Seven of us in a converted print works, working on four or five buildings at a time. Every project is run by a director who is on site.", "xl", "#78716c", "left"),
        ),
        sec("#fafafa", 64, "5xl", "left",
          h("How we work", 2, "#292524", "bold", "left"),
          s(24),
          lst([
            "We survey and draw everything ourselves, including what is already there.",
            "One director stays with a project from first sketch to the final inspection.",
            "We model daylight and heat loss early, when changing them is still free.",
            "We name a budget in the first month and tell you the week it stops being true.",
          ], "check"),
        ),
        sec("#ffffff", 64, "4xl", "center",
          q("They talked us out of the extension we asked for and into the one we needed. Two years on, we would not change a room.", "Helen Mbeki", "Hillside House", "center"),
          s(32),
          navBtn("See the built work", "projects", "", "outline", "md", "center"),
        ),
      ],
    }],
  },
    ...
    pages: [{
      ...
      blocks: [
        sec("#f8fafc", 96, "5xl", "left",
          ...
          s(24),
          b("button", { label: "Get started →", href: templateLink("getting-started"), variant: "primary", size: "md", align: "left", color: "", textColor: "#ffffff" } as any),
        ),
        sec("#ffffff", 64, "5xl", "left",
      ...
      title: "Getting started", slug: "getting-started", published: true,
      blocks: [
        sec("#f8fafc", 96, "5xl", "left",
          t("GUIDE", "sm", "#94a3b8", "left"),
          s(8),
          h("Getting started", 1, "#171717", "bold", "left"),
          s(16),
          t("Install, authenticate, and make your first call. About five minutes, and you need nothing but a terminal.", "xl", "#475569", "left"),
        ),
        sec("#ffffff", 96, "5xl", "left",
          h("1. Install", 3, "#171717", "bold", "left"),
          s(12),
          t("The client is published for Node, Python and Go. All three expose the same method names.", "base", "#475569", "left"),
          s(24),
          h("2. Authenticate", 3, "#171717", "bold", "left"),
          s(12),
          t("Create a key in the dashboard and set it as an environment variable. Keys are scoped per project and can be rotated without downtime.", "base", "#475569", "left"),
          s(24),
          h("3. Make a call", 3, "#171717", "bold", "left"),
          s(12),
          t("Every endpoint returns the same envelope: a data object, a request id, and a pagination cursor where one applies.", "base", "#475569", "left"),
        ),
        sec("#f8fafc", 96, "5xl", "left",
          h("Where to go next", 2, "#171717", "bold", "left"),
          s(16),
          lst([
            "The API reference, for every endpoint and field",
            "Webhooks, if you need to be told rather than to ask",
            "Rate limits and retries, before you go to production",
          ], "bullet"),
          s(24),
          navBtn("Open the API reference", "api", "", "primary", "md", "left"),
        ),
      ],
    }, {
      title: "API reference", slug: "api", published: true,
      blocks: [
        sec("#f8fafc", 96, "5xl", "left",
          t("REFERENCE", "sm", "#94a3b8", "left"),
          s(8),
          h("API reference", 1, "#171717", "bold", "left"),
          s(16),
          t("Everything is REST over HTTPS, JSON in and JSON out, with cursor pagination. There is one version and we do not break it.", "xl", "#475569", "left"),
        ),
        sec("#ffffff", 96, "5xl", "left",
          h("Resources", 2, "#171717", "bold", "left"),
          s(24),
          cells(2, 40,
            [
              b("heading", { text: "Projects", level: 4, align: "left", color: "#171717", weight: "semibold" } as any),
              t("List, create, update and archive. Archiving is reversible for 30 days.", "base", "#475569", "left"),
            ],
            [
              b("heading", { text: "Events", level: 4, align: "left", color: "#171717", weight: "semibold" } as any),
              t("Append-only. Query by type, by actor or by time window, newest first.", "base", "#475569", "left"),
            ],
          ),
          s(32),
          cells(2, 40,
            [
              b("heading", { text: "Webhooks", level: 4, align: "left", color: "#171717", weight: "semibold" } as any),
              t("Signed with a shared secret and retried for 24 hours with exponential backoff.", "base", "#475569", "left"),
            ],
            [
              b("heading", { text: "Keys", level: 4, align: "left", color: "#171717", weight: "semibold" } as any),
              t("Scoped per project, rotatable in place, and never shown again after creation.", "base", "#475569", "left"),
            ],
          ),
        ),
        sec("#f8fafc", 96, "5xl", "left",
          h("Limits", 2, "#171717", "bold", "left"),
          s(16),
          lst([
            "1,000 requests a minute per key, burst to 2,000",
            "Page size up to 200, default 50",
            "Responses over 6 MB are paginated regardless of page size",
          ], "bullet"),
          s(24),
          navBtn("Back to getting started", "getting-started", "", "outline", "md", "left"),
        ),
      ],
    }],
  },
    ...
    pages: [{
      ...
      blocks: [
        sec("#fdf2f8", 96, "site", "center",
          ...
          s(32),
          b("columns", { count: 2, gap: 16 }, [
            navBtn("Shop now", "shop", "", "primary", "lg", "center"),
            b("button", { label: "Shipping & returns", href: templateLink("shipping"), variant: "outline", size: "lg", align: "center", color: "", textColor: "#be185d" } as any),
          ]),
          s(48),
      ...
      title: "Shop", slug: "shop", published: true,
      blocks: [
        sec("#fdf2f8", 96, "site", "center",
          t("EVERYTHING", "sm", "#be185d", "center"),
          s(8),
          h("The shop", 1, "#171717", "bold"),
          s(16),
          t("Small batches, made to order, sent within three days. When something is gone it is gone until the next run.", "xl", "#475569", "center"),
        ),
        sec("#ffffff", 96, "site", "left",
          cells(3, 32,
            [
              b("heading", { text: "Everyday Tote  ·  $68", level: 4, align: "left", color: "#171717", weight: "semibold" } as any),
              t("Waxed canvas, leather handles, big enough for a laptop and a loaf of bread.", "base", "#475569", "left"),
            ],
            [
              b("heading", { text: "Weekender  ·  $145", level: 4, align: "left", color: "#171717", weight: "semibold" } as any),
              t("Two nights' worth, a separate shoe compartment, and a strap that does not dig in.", "base", "#475569", "left"),
            ],
            [
              b("heading", { text: "Card Wallet  ·  $42", level: 4, align: "left", color: "#171717", weight: "semibold" } as any),
              t("Four cards and folded notes. It gets better looking for about a year.", "base", "#475569", "left"),
            ],
          ),
          s(40),
          cells(3, 32,
            [
              b("heading", { text: "Apron  ·  $58", level: 4, align: "left", color: "#171717", weight: "semibold" } as any),
              t("Cross-back, so nothing pulls on your neck. Washes well and keeps its shape.", "base", "#475569", "left"),
            ],
            [
              b("heading", { text: "Tool Roll  ·  $76", level: 4, align: "left", color: "#171717", weight: "semibold" } as any),
              t("Eight pockets and a tie closure. Sized for chisels, brushes or knives.", "base", "#475569", "left"),
            ],
            [
              b("heading", { text: "Dopp Kit  ·  $54", level: 4, align: "left", color: "#171717", weight: "semibold" } as any),
              t("Wipe-clean lining, wide opening, stands up on its own when full.", "base", "#475569", "left"),
            ],
          ),
        ),
        sec("#fdf2f8", 80, "4xl", "center",
          h("Made to order", 2, "#171717", "bold"),
          s(12),
          t("Everything is cut and sewn after you order it, which is why it takes three days and why it lasts.", "lg", "#475569", "center"),
          s(24),
          navBtn("Shipping & returns", "shipping", "", "primary", "lg", "center"),
        ),
      ],
    }, {
      title: "Shipping & returns", slug: "shipping", published: true,
      blocks: [
        sec("#fdf2f8", 96, "4xl", "center",
          h("Shipping & returns", 1, "#171717", "bold"),
          s(16),
          t("Short version: three days to make, two to arrive, and a year to change your mind.", "xl", "#475569", "center"),
        ),
        sec("#ffffff", 96, "5xl", "left",
          cells(3, 32,
            [
              b("heading", { text: "Making", level: 4, align: "left", color: "#171717", weight: "semibold" } as any),
              t("Three working days, because nothing is made before it is ordered. You get a photo of yours before it ships.", "base", "#475569", "left"),
            ],
            [
              b("heading", { text: "Sending", level: 4, align: "left", color: "#171717", weight: "semibold" } as any),
              t("Free over $75 in the US, $12 below that, and $24 to anywhere else. Tracked either way.", "base", "#475569", "left"),
            ],
            [
              b("heading", { text: "Returning", level: 4, align: "left", color: "#171717", weight: "semibold" } as any),
              t("Unused, within a year, for a full refund — postage included. Used and unhappy? Write to us anyway.", "base", "#475569", "left"),
            ],
          ),
        ),
        sec("#fdf2f8", 80, "4xl", "center",
          h("Repairs, for as long as you own it", 2, "#171717", "bold"),
          s(12),
          t("Stitching, hardware and straps, repaired free. Send it back and we will return it in about two weeks.", "lg", "#475569", "center"),
          s(24),
          form("Arrange a repair", "Thank you — we will email you a prepaid label within the day."),
        ),
      ],
    }],
  },
